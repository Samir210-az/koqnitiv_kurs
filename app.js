/* ==== KDT Kursu — Ortaq JS: scroll reveal, parallax, seans modalı ==== */
...
/* Seans pop-up sistemi — hər modul öz SESSIONS massivini təyin edir */
function renderSession(s, total){
...
function openSession(n){
  ...
  if(!s) return;
  document.getElementById('modalContent').innerHTML = renderSession(s, SESSIONS.length);
